...
public class data_setting_to_db {
	...
	public static void main(String[] args) throws SQLException {
		...
		String query="insert into student (id,first_name,address) values ('12','suhan','uganda')";
		String query1="insert into student (id,first_name,address) values ('13','shan','austrlia')";
